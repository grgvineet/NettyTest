...
public class MySslContext {
    ...
    public static SSLContext getSslContext(Context context,boolean isClient) {
...
//            SelfSignedCertificate certificate = new SelfSignedCertificate("CN=Vineet,O=Netty,ST=Some-State,C=IN")
